  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white p-12 rounded-lg border border-gray-200 shadow-sm flex flex-col items-center text-center mt-8">
          <BarChart3 className="h-10 w-10 text-gray-400 mb-4" />
          <h2 className="text-xl font-bold text-gray-900 mb-2">Detailed Charts Coming Soon</h2>
